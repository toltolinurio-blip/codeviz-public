...
**Non-Latin labels** — extend the family: [Korean](references/style-guide.md#korean-labels), [Chinese](references/style-guide.md#traditional-chinese-labels), [Cyrillic](references/style-guide.md#cyrillic-labels). Korean-speaking users: see [`references/korean-guide.md`](references/korean-guide.md) for the 41-type table in Korean and [`assets/example-flowchart-ko.html`](assets/example-flowchart-ko.html) for a Korean-labeled example.
